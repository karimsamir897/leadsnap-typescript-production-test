import fs from 'fs';
import type { ResponseLike } from 'leadsnap-test-typescript/internal/to-file';
import { toFile } from 'leadsnap-test-typescript/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('leadsnap-test-typescript/core/uploads');
    await expect(
